...
- Designing, manufacturing, assembling, verifying, and distributing products in accordance with defined requirements
- Implementing and maintaining an effective Quality Management System based on ISO 9001
- Ensuring quality is built into our processes through order review, verification, and control of nonconforming outputs
- Maintaining controlled documentation and records to support consistency and traceability
- Promoting competence, accountability, and quality awareness across our team
- Continually improving our processes, products, and Quality Management System
Top management is committed to supporting the Quality Management System, providing the necessary resources, and ensuring this policy is understood, implemented, and maintained at all levels of the organization.
...
- Components are assembled into finished thermocouple assemblies.
- Assembly follows defined work practices and job requirements.

## 6. Calibration / Verification (QC)
- Finished assemblies are calibrated or verified against defined acceptance criteria.
- Verification results are recorded.
- Pass / fail decisions are made by authorized personnel
- Nonconforming Output
- If verification fails, the product is not shipped.
- Rework or scrap decisions are made and recorded.
- Record: Verification / Calibration record or Work Order sign-off

## 7. Labeling & Identification
- Products are labeled or identified with job or work order information.
- Traceability is maintained as applicable to product requirements.

## 8. Final Review & Packaging (QC)
- Final checks confirm:
- correct product
- correct customer
- required documentation present
- Packaging is completed after successful final review.
- Record: Work Order (Final review sign-off)
